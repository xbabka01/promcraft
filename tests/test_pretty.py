...
def test_aggregation_pretty_multi_param() -> None:
    ...
    assert expr.to_string(indent=4) == "topk(\n    5.0,\n    metric{}\n)"
...
def test_range_vector_pretty_no_labels_stays_compact() -> None:
    ...
    assert vec.to_string(indent=4) == "metric{}[5m]"
